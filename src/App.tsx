...
export default function App() {
  ...
  // Track voted states for yesterday's question as well
  const [yesterdayVotes, setYesterdayVotes] = useState<Record<string, { hasVoted: boolean; choice: 'yes' | 'no' | null }>>({});
  ...
  // Full archive list (everything older than today)
      ...
      <div>
        ...
        {view === 'home' ? (
          <div>
            ...
            {yesterdayQuestion && (
              <section className="border-t border-neutral-800 pt-6">
                <h3 className="text-sm font-bold tracking-widest text-neutral-400 mb-4">YESTERDAY</h3>
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-sm font-bold tracking-widest text-neutral-400 border-b border-neutral-800 pb-2">
